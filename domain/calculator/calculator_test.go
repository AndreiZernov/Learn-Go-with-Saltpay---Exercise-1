...
func TestAdder(t *testing.T) {
	adderTest := []struct {
		...
		{name: "Given a one number should return the same number", numbers: "1", sum: 1},
		...
		{name: "Given a numbers and non-numbers should ignore non-numbers and return calculator of numbers", numbers: "add,2,2", sum: 4},
		{name: "Given a float in a list of numbers should return the calculator of only integers", numbers: "0,2.4,2", sum: 2},
