...
func TestDataRetriever_GetData(t *testing.T) {
	adderTest := []struct {
		...
		{name: "Given an arguments --input-file data/input.txt should return numbers inside", arguments: []string{"--input-file", "data/input.txt"}, numbers: "4\n5\n32\n100\n867543,"},
		{name: "Given an arguments --input-file twice should return string of numbers merged from both files", arguments: []string{"--input-file", "data/input.txt", "--input-file", "data/input2.csv"}, numbers: "4\n5\n32\n100\n867543,4,5,32,100,867543,"},
		...
		{name: "Given no arguments should return default numbers from data/input.txt file", arguments: []string{}, numbers: "4\n5\n32\n100\n867543"},
	}
